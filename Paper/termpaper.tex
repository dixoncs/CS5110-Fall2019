...
\section{Figures}
\begin{center}
	\includegraphics[scale=.5]{hollownodeuml.png}\\
...
\begin{center}
	\includegraphics[scale=.5]{fibonaccinode.png}\\
...
\begin{center}
	\includegraphics[scale=.5]{nodeuml.png}\\
